package com.example.asus.tasklistmanagement.login;
...
public class Login extends AppCompatActivity {
    ...
    private String login_url = "http://192.168.175.2/Member(tasklist)/db/login.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etPassword = findViewById(R.id.pw_edt);
